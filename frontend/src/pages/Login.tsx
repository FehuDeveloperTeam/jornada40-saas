...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setErrorMsg('Credenciales corporativas incorrectas.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="w-full max-w-[420px] animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="bg-white/80 backdrop-blur-2xl p-8 sm:p-10 rounded-[2rem] shadow-[0_8px_40px_rgb(0,0,0,0.04)] border border-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* MENSAJE DE ERROR */}
              {errorMsg && (
                <div className="bg-red-50/80 text-red-600 p-3.5 rounded-xl text-sm font-medium text-center border border-red-100 flex items-center justify-center gap-2 animate-in fade-in zoom-in-95 duration-300">
