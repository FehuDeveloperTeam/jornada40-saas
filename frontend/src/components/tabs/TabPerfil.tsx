...
export default function TabPerfil({ panelMode, selectedEmpleado, formData, isValidRut, handleInputChange, onSubmit }: Props) {
  if (panelMode === 'view' && selectedEmpleado) {
    return (
  ...
  return (
    <form id="empleadoForm" onSubmit={onSubmit} className="grid grid-cols-2 gap-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input type="text" name="numero_telefono" value={formData.numero_telefono || ''} onChange={handleInputChange} placeholder="912345678" className="w-full pl-11 pr-3 py-2 rounded-lg border border-slate-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all" />
            </div>
          </div>
          <div className="col-span-2">
