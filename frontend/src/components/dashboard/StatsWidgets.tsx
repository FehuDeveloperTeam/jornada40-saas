  ...
  return (
    <div className="mb-8">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-slate-600 font-semibold text-sm hover:bg-slate-50 hover:border-slate-300 transition-colors shadow-sm mb-4"
      >
      ...
      {isOpen && (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 animate-in slide-in-from-top-2 fade-in duration-300">
              ...
              <div className="flex items-center gap-4 animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="w-full pr-6">
                  ...
                  <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden flex mt-2">
                    <div style={{ width: `${(stats.mujeres / stats.total) * 100}%` }} className="bg-fuchsia-400 h-full" />
                    <div style={{ width: `${(stats.hombres / stats.total) * 100}%` }} className="bg-blue-400 h-full" />
                  </div>
                </div>
              </div>
            ) : (
