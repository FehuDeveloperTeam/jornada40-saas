...
from .views import (
    ...
    SolicitudFirmaViewSet, VacacionViewSet, mi_suscripcion, recuperar_password_por_rut, diagnostico_red, indicadores_del_dia,
    ...
    FiniquitoViewSet, ConceptoRemuneracionViewSet,
)
